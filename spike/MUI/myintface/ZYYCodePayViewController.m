...
- (void)viewDidLoad {
    ...
    // 3. 将字符串转换成NSData
    NSString *urlStr =@" https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=9_12&index=2";
    ...
    UIImageView *wechatImageView = [[UIImageView alloc] initWithFrame:CGRectMake(40, 88, SCREEN_WIDTH - 80, SCREEN_WIDTH - 80)];

//
//  skiresortsViewController.m
//  spike
//
//  Created by 泽联教育 on 2018/6/6.
...
@interface skiresortsViewController (){
...
@implementation skiresortsViewController
...
-(void)loadNewData{
    ...
    ary= [dd objectForKey:@"mysikearry"];
